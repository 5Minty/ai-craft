...
def get_params():
    try:
        ...
        base_x = int(input("Enter the base X coordinate: "))
        base_y = int(input("Enter the base Y coordinate: "))
        base_z = int(input("Enter the base Z coordinate: "))
        
        # Optionally you can add more inputs or settings here
...
base_x, base_y, base_z = get_params()

build_shack(base_x, base_y, base_z, "south")
